...
namespace openfl.display3D
{
	...
	**/
	export class Context3D extends EventDispatcher
	{
		...
		**/
		public static supportsVideoTexture(default , null): boolean = true;
		...
		**/
		public backBufferHeight(default , null): number = 0;
		...
		/**
			...
			for the browser zoom change event.
		**/
		public backBufferWidth(default , null): number = 0;
		...
		**/
		...
		protected get_totalGPUMemory(): number
		{
