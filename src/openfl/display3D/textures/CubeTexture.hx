...
{
	@:noCompletion private var __backend:CubeTextureBackend;
	...
	@:noCompletion private function new(context:Context3D, size:Int, format:Context3DTextureFormat, optimizeForRenderToTexture:Bool, streamingLevels:Int)
	{
		...
		__backend = new CubeTextureBackend(this);
...
#if openfl_gl
private typedef CubeTextureBackend = openfl._internal.backend.opengl.OpenGLCubeTextureBackend;
#else
private typedef CubeTextureBackend = openfl._internal.backend.dummy.DummyCubeTextureBackend;
#end
#else
