...
{
	@:noCompletion private var __baseBackend:TextureBaseBackend;
...
#if openfl_gl
private typedef TextureBaseBackend = openfl._internal.backend.opengl.OpenGLTextureBaseBackend;
#else
private typedef TextureBaseBackend = openfl._internal.backend.dummy.DummyTextureBaseBackend;
#end
#else
