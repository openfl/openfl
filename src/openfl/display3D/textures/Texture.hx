...
{
	@:noCompletion private var __backend:TextureBackend;
			...
			streamingLevels:Int)
	{
		...
		__backend = new TextureBackend(this);
...
#if openfl_gl
private typedef TextureBackend = openfl._internal.backend.opengl.OpenGLTextureBackend;
#else
private typedef TextureBackend = openfl._internal.backend.dummy.DummyTextureBackend;
#end
#else
