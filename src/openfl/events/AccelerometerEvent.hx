...
class AccelerometerEvent extends Event
{
	/**
		...
		listener.</entry></row><row><entry>`timestamp`</entry><entry>The
		timestamp of the Accelerometer
		update.</entry></row><row><entry>`accelerationX`</entry><entry>The
		acceleration value in Gs (9.8m/sec/sec) along the
		x-axis.</entry></row><row><entry>`accelerationY`</entry><entry>The
		acceleration value in Gs (9.8m/sec/sec) along the y-axis.
		</entry></row><row><entry>`accelerationZ`</entry><entry>The
		acceleration value in Gs (9.8m/sec/sec) along the z-axis.
