...
class ShapeCache
{
	...
	public function cache(formatRange:TextFormatRange, getPositions:#if (js && html5) {function():Array<Float>}, wordKey:String = null):Array<Float> #else TextLayout):Array<GlyphPosition>#end
	{
	...
	private function __cacheShortWord(wordKey:String, formatKey:String, getPositions:#if (js && html5) {function():Array<Float>}):Array<Float> #else TextLayout):Array<GlyphPosition> #end
	{
	...
	private function __cacheLongWord(wordKey:String, formatKey:String, getPositions:#if (js && html5) {function():Array<Float>}):Array<Float> #else TextLayout):Array<GlyphPosition> #end
	{
