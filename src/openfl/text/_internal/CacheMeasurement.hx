...
class CacheMeasurement
{
	...
	private var __wordMap:IntMap<Dynamic>;
	public var hash:Int;

	public function new(wordKey:String, positions:Dynamic)
	{
	...
	public function set(wordKey:String, positions:Dynamic):Void
	{
		__addCollision(wordKey, positions);
	}

	public function get(wordKey:String):Dynamic
	{
	...
	private function __addCollision(wordKey:String, positions:Dynamic):Void
	{
	...
	public function exists(wordKey:Dynamic):Bool
	{
