...
@:final class ShaderParameter<T> /*implements Dynamic*/
{
	...
	**/
	...
	@:noCompletion private var __backend:ShaderParameterBackend<T>;
...
#if openfl_gl
private typedef ShaderParameterBackend<T> = openfl._internal.backend.opengl.OpenGLShaderParameterBackend<T>;
#else
private typedef ShaderParameterBackend<T> = openfl._internal.backend.dummy.DummyShaderParameterBackend<T>;
#end
#else
