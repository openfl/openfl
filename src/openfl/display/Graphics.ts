...
// import DisplayObjectRenderData from "openfl/_internal/renderer/DisplayObjectRenderData";
...
namespace openfl.display
{
	...
	**/
	export class Graphics
	{
		...
		protected __dirty(default , set): boolean = true;
		...
		protected __usedShaderBuffers: List<ShaderBuffer>;
		...
		#if draft
		protected __drawPaths: Array<openfl._internal.renderer.opengl.utils.DrawPath>;
		protected __glStack: Array<openfl._internal.renderer.opengl.utils.GLStack> = [];
		#end
		...
		**/
		public beginGradientFill(type: GradientType, colors: Array<Int>, alphas: Array<Float>, ratios: Array<Int>, matrix: Matrix = null,
			spreadMethod: SpreadMethod = SpreadMethod.PAD, interpolationMethod: numbererpolationMethod = InterpolationMethod.RGB, focalPointRatio: number = 0): void
		{
		...
		**/
		...
		/**
			...
			![radial gradient with focalPointRatio set to 0.75](/images/radial_sketch.jpg)
		**/
		public lineGradientStyle(type: GradientType, colors: Array<Int>, alphas: Array<Float>, ratios: Array<Int>, matrix: Matrix = null,
			spreadMethod: SpreadMethod = SpreadMethod.PAD, interpolationMethod: numbererpolationMethod = InterpolationMethod.RGB, focalPointRatio: number = 0): void
		{
	...
	/** @hidden */ public overrideBlendMode(blendMode: BlendMode): void
		{
		...
		**/
		...
		// Get & Set Methods
		protected set___dirty(value: boolean): boolean
		{
