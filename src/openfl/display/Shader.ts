...
namespace openfl.display
{
	...
	**/
	export class Shader
	{
		...
		**/
		public byteCode(null, default ): ByteArray;
		...
		**/
		public data(get, set): ShaderData;
		...
		**/
		public glFragmentSource(get, set): string;
		...
		/**
			...
			This property is not available on the Flash target.
		**/
		@SuppressWarnings("checkstyle:Dynamic") public glProgram(default , null): GLProgram;
		...
		/**
			...
			This property is not available on the Flash target.
		**/
		public glVertexSource(get, set): string;
		...
		**/
		...
		protected __alpha: ShaderParameter<Float>;
		protected __alphaTexture: ShaderInput<BitmapData>;
		protected __alphaTextureMatrix: ShaderParameter<Float>;
		protected __backend: ShaderBackend;
		protected __bitmap: ShaderInput<BitmapData>;
		protected __colorMultiplier: ShaderParameter<Float>;
		protected __colorOffset: ShaderParameter<Float>;
		protected __data: ShaderData;
		protected __hasColorTransform: ShaderParameter<Bool>;
		...
		protected __matrix: ShaderParameter<Float>;
		protected __position: ShaderParameter<Float>;
		protected __textureCoord: ShaderParameter<Float>;
		protected __texture: ShaderInput<BitmapData>;
		protected __textureSize: ShaderParameter<Float>;
