...
export default class ShaderJob extends EventDispatcher
{
	...
	**/
	...
	/**
		...
		instance.
	**/
	public target: BitmapData | ByteArray | Vector<number>;
	...
	**/
	...
	/**
		...
		@param height The height of the result data in the `target` if it is a
						...
						necessary and existing data is overwritten.
	**/
	public constructor(shader: Shader = null, target: BitmapData | ByteArray | Vector<number> = null, width: number = 0, height: number = 0)
	{
		super();
