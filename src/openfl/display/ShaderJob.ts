	...
	export class ShaderJob extends EventDispatcher
	{
		...
		**/
		...
		/**
			...
			starts again.
		**/
		public progress(default , null): number;
		...
		**/
		...
		/**
			...
			instance.
		**/
		@SuppressWarnings("checkstyle:Dynamic") public target: Dynamic;
		...
		**/
		...
		public constructor(shader: Shader = null, target: Dynamic = null, width: number = 0, height: number = 0)
		{
			super();
