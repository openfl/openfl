...
import FocusEvent from "../events/EventPhase";
...
if (__dragObject != null)
{
	...
	// Get & Set Methods
	public get color(): Null < Int >
{
	return __color;
}

	public set color(value: null | number): Null < Int >
{
	if(value == null)
{
	__transparent = true;
	...
	public get displayState(): StageDisplayState
{
	...
	public set displayState(value: StageDisplayState): StageDisplayState
{
	...
	public get focus() : InteractiveObject
{
	...
	public set focus(value : InteractiveObject) : InteractiveObject
{
	if (value != __focus)
	{
	...
	public get frameRate() : number
{
	...
	public set frameRate(value : number) : number
{
	...
	public get fullScreenSourceRect(): Rectangle
{
	...
	public set fullScreenSourceRect(value: Rectangle): Rectangle
{
	if (value == null)
	{
	...
	public get quality(): StageQuality
{
	...
	public set quality(value: StageQuality): StageQuality
{
	__quality = value;
	...
	public get scaleMode(): StageScaleMode
{
	...
	public set scaleMode(value: StageScaleMode): StageScaleMode
{
	// TODO
...
public set tabEnabled(value : boolean) : boolean
{
...
public set tabIndex(value : number) : number
{
	throw new IllegalOperationError("Error: The Stage class does not implement this property or method.");
}

public set transform(value: Transform): Transform
{
