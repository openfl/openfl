...
namespace openfl.display
{
	...
	**/
	export class GraphicsGradientFill implements IGraphicsData implements IGraphicsFill
	{
		/**
		...
		**/
		public interpolationMethod: numbererpolationMethod;
		...
		**/
		...
		/**
			...
			@param focalPointRatio     A number that controls the location of the
									   ...
									   respectively.
		**/
		public constructor(type: GradientType = null, colors: Array<Int> = null, alphas: Array<Float> = null, ratios: Array<Int> = null, matrix: Matrix = null,
			spreadMethod: SpreadMethod = null, interpolationMethod: numbererpolationMethod = null, focalPointRatio: number = 0)
		{
			if (type == null)
			{
