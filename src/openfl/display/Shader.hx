...
class Shader
{
	...
	**/
	...
	@:noCompletion private var __backend:ShaderBackend;
...
#if openfl_gl
private typedef ShaderBackend = openfl._internal.backend.opengl.OpenGLShaderBackend;
#else
private typedef ShaderBackend = openfl._internal.backend.dummy.DummyShaderBackend;
#end
#else
