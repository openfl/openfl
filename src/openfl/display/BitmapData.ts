...
namespace openfl.display
{
	...
	**/
	export class BitmapData implements IBitmapDrawable
	{
		...
		**/
		public readable(default , null): boolean;
		...
		**/
		public rect(default , null): Rectangle;
		...
		**/
		public transparent(default , null): boolean;
		...
		**/
		...
		protected __backend: BitmapDataBackend;
		...
		**/
		...
		protected __getCanvas(clearData: boolean = false): CanvasElement
		{
			return __backend.getCanvas(clearData);
		}

		protected __getCanvasContext(clearData: boolean = false): Canvas2DRenderContext
		{
			return __backend.getCanvasContext(clearData);
		}

		protected __getElement(clearData: boolean = false): Dynamic
		{
			return __backend.getElement(clearData);
		}

		protected __getJSImage(): JSImage
		{
