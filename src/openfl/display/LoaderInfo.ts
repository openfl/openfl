...
namespace openfl.display
{
	...
	**/
	...
	{
		protected static __rootURL: string = #if openfl_html5(Browser.supported? Browser.document.URL: "") #else "" #end;
		...
		**/
		public applicationDomain(default , null): ApplicationDomain;
		...
		**/
		public bytes(default , null): ByteArray;
		...
		**/
		public childAllowsParent(default , null): boolean;
		...
		/**
			...
			@throws SecurityError If the object accessing this API is prevented from
								  ...
								  [Security](http://www.adobe.com/go/devnet_security_en).
		**/
		public content(default , null): DisplayObject;
		...
		/**
			...
			* `"image/png"`
		**/
		public contentType(default , null): string;
		...
		**/
		public frameRate(default , null): number;
		...
		**/
		...
		/**
			...
			@throws SecurityError If the object accessing this API is prevented from
								  ...
								  [Security](http://www.adobe.com/go/devnet_security_en).
		**/
		public loader(default , null): Loader;
		...
		**/
		public loaderURL(default , null): string;
		...
		**/
		...
		public parameters(default , null): Dynamic<string>;
		...
		/**
			...
			@throws Error Thrown if the file is not downloaded sufficiently to
						  retrieve the requested information.
		**/
		public parentAllowsChild(default , null): boolean;
		...
		/**
			...
			@throws Error Thrown if the file is not downloaded sufficiently to
						  retrieve the requested information.
		**/
		public sameDomain(default , null): boolean;
		...
		/**
			...
			object.
		**/
		public sharedEvents(default , null): EventDispatcher;
		...
		**/
		public uncaughtErrorEvents(default , null): UncaughtErrorEvents;
		...
		**/
		public url(default , null): string;
