...
namespace openfl.display
{
	...
	**/
	export class Loader extends DisplayObjectContainer
	{
		...
		**/
		public contentLoaderInfo(default , null): LoaderInfo;
		...
		**/
		...
		publicremoveChildAt(index: number): DisplayObject
		{
			throw new Error("Error #2069: The Loader class does not implement this method.", 2069);
			return null;
		}

		publicsetChildIndex(child: DisplayObject, index: number): void
		{
			throw new Error("Error #2069: The Loader class does not implement this method.", 2069);
		}
		...
		**/
		...
		protected BitmapData_onError(error: Dynamic): void
		{
