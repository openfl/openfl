...
namespace openfl.net
{
	...
	**/
	export class FileReference extends EventDispatcher
	{
		...
		**/
		public creationDate(default , null): Date;
		...
		**/
		public creator(default , null): string;
		...
		/**
			...
			@throws IllegalOperationError If the `load()` method was not called
										  ...
										  property is `null`.
		**/
		public data(default , null): ByteArray;
		...
		/**
			...
			@throws IllegalOperationError If the `FileReference.browse()`,
										  ...
										  `null`.
		**/
		public modificationDate(default , null): Date;
		...
		**/
		...
		/**
			...
			@throws IllegalOperationError If the `FileReference.browse()`,
										  ...
										  unsuccessful.
		**/
		public size(default , null): number;
		...
		**/
		...
		protected __backend: FileReferenceBackend;
