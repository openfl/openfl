...
/**
	...
	**Remote shared objects.** With Flash Media Server, you can create
	...
	@event sync       Dispatched when a remote shared object has been updated
					  by the server.
**/
export default class SharedObject extends EventDispatcher
{
	/**
	...
	**/
	...
	// /** @hidden */ @:dox(hide) @:require(flash11_7) public static preventBackup:Bool;
	...
	**/
	public static getLocal(name: string, localPath: string = null, secure: boolean = false /* note: unsupported**/): SharedObject
	{
		var illegalValues = [" ", "~", "%", "&", "\\", ";", ":", "\"", "'", ",", "<", ">", "?", "#"];
		var allowed = true;
