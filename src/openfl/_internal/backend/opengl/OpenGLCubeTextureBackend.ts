...
{
	private framebufferSurface: number;
	...
	privategetGLFramebuffer(enableDepthAndStencil: boolean, antiAlias: number, surfaceSelector: number): GLFramebuffer
	{
	...
	privatesetSamplerState(state: SamplerState): boolean
	{
