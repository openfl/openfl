...
class OpenGLShaderParameterBackend<T> /*implements Dynamic*/
{
	...
	private parent: ShaderParameter<T>;
	...
	private disableGL(context: Context3D): void
	{
	...
	private updateGL(context: Context3D, overrideValue: Array<T> = null): void
	{
		var gl = context.__backend.gl;
	...
	private updateGLFromBuffer(context: Context3D, buffer: Float32Array, position: number, length: number, bufferOffset: number): void
	{
		var gl = context.__backend.gl;
