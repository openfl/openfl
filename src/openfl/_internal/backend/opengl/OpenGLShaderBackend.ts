...
class OpenGLShaderBackend
{
	...
	private inputBitmapData: Array<ShaderInput<BitmapData>>;
	private numPasses: number;
	private paramBool: Array<ShaderParameter<Bool>>;
	private paramFloat: Array<ShaderParameter<Float>>;
	...
	private createGLShader(source: string, type: number): GLShader
	{
	...
	private createGLProgram(vertexSource: string, fragmentSource: string): GLProgram
	{
	...
	private processGLData(source: string, storageType: string): void
	{
	...
	private updateFromBuffer(shaderBuffer: ShaderBuffer, bufferOffset: number): void
	{
		if (parent.program != null)
		{
	...
	private updateGLFromBuffer(shaderBuffer: ShaderBuffer, bufferOffset: number): void
	{
		var textureCount = 0;
