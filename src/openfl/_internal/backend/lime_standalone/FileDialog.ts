...
class FileDialog
{
	public onCancel = new Event < Void -> Void > ();
	public onOpen = new Event < Resource -> Void > ();
	public onSave = new Event < String -> Void > ();
	...
	public open(filter: string = null, defaultPath: string = null, title: string = null): boolean
	{
		#if desktop
		var worker = new BackgroundWorker();
	...
	public save(data: Resource, filter: string = null, defaultPath: string = null, title: string = null, type: string = "application/octet-stream"): boolean
	{
		if (data == null)
		{
			onCancel.dispatch();
