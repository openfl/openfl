...
{
	#if !macro
	macro public static cacheVersion() { }
	#else
	macro public static cacheVersion()
	{
	...
	macro public static embedBytes(): Array<Field>
	{
		...
		if (fields != null)
		{
			...
			var args = [
				{ name: "length", opt: true, type: macro : number },
	...
	macro public static embedBytesHL(): Array<Field>
	{
		var fields = embedData(":file");
	...
	macro public static embedByteArray(): Array<Field>
	{
		var fields = embedData(":file");
	...
	private static embedData(metaName: string, encode: boolean = false): Array<Field>
	{
		#if!display
	...
	macro public static embedFont(): Array<Field>
	{
		var fields = null;
	...
	macro public static embedImage(): Array<Field>
	{
		#if html5
	...
	macro public static embedSound(): Array<Field>
	{
