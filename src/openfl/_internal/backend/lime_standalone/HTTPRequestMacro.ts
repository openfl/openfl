namespace openfl._internal.backend.lime_standalone; #if macro
...
class HTTPRequestMacro
{
	...
	private static isBytesAbstract(type: AbstractType) : boolean
{
	while (type != null)
	{
		switch (type.type)
	...
	private static isStringAbstract(type: AbstractType) : boolean
{
	while (type != null)
	{
		switch (type.type)
