...
{
	public bufferData(target : number, srcData:#if(!js || !html5 || display) ArrayBufferView #else Dynamic #end, usage : number): void
		{
			this.bufferData(target, srcData, usage);
		}

	public inline bufferSubData(target : number, offset : number, srcData:#if(!js || !html5 || display) ArrayBufferView #else Dynamic #end): void
		{
			this.bufferSubData(target, offset, srcData);
		}

	public compressedTexImage2D(target : number, level : number, internalformat : number, width : number, height : number, border : number,
	...
	public inline compressedTexSubImage2D(target : number, level : number, xoffset : number, yoffset : number, width : number, height : number, format : number,
					srcData:#if(!js || !html5 || display) ArrayBufferView #else Dynamic #end): void
						{
							this.compressedTexSubImage2D(target, level, xoffset, yoffset, width, height, format, srcData);
						}

	public inline readPixels(x : number, y : number, width : number, height : number, format : number, type : number,
	...
	public inline texImage2D(target : number, level : number, internalformat : number, width : number, height : number, border : number, format : number, type : number,
									srcData: ArrayBufferView): void
										{
											this.texImage2D(target, level, internalformat, width, height, border, format, type, srcData);
										}
	#else
	// public texImage2D (target:Int, level:Int, internalformat:Int, format:Int, type:Int, pixels:Dynamic /*ImageBitmap*/):Void {
	// public texImage2D (target:Int, level:Int, internalformat:Int, format:Int, type:Int, pixels:#if (js && html5) CanvasElement #else Dynamic #end):Void {
	// public texImage2D (target:Int, level:Int, internalformat:Int, format:Int, type:Int, pixels:#if (js && html5) ImageData #else Dynamic #end):Void {
	// public texImage2D (target:Int, level:Int, internalformat:Int, format:Int, type:Int, pixels:#if (js && html5) ImageElement #else Dynamic #end):Void {
	// public texImage2D (target:Int, level:Int, internalformat:Int, format:Int, type:Int, pixels:#if (js && html5) VideoElement #else Dynamic #end):Void {
	// public texImage2D (target:Int, level:Int, internalformat:Int, width:Int, height:Int, border:Int, format:Int, type:Int, srcData:ArrayBufferView):Void {
	public texImage2D(target : number, level : number, internalformat : number, width : number, height : number, border: Dynamic, ?format : number, ?type : number, ?srcData: Dynamic): void
		{
			this.texImage2D(target, level, internalformat, width, height, border, format, type, srcData);
		}
	#end
	...
	#if(!js || !html5 || lime_doc_gen)
	public inline texSubImage2D(target : number, level : number, xoffset : number, yoffset : number, width : number, height : number, format : number, type : number,
			srcData: ArrayBufferView, srcOffset : number = 0): void
				{
					this.texSubImage2D(target, level, xoffset, yoffset, width, height, format, type, srcData, srcOffset);
				}
	#else
	// public texSubImage2D (target:Int, level:Int, xoffset:Int, yoffset:Int, format:Int, type:Int, pixels:#if (js && html5) CanvasElement #else Dynamic #end):Void {
	// public texSubImage2D (target:Int, level:Int, xoffset:Int, yoffset:Int, format:Int, type:Int, pixels:Dynamic /*ImageBitmap*/):Void {
	// public texSubImage2D (target:Int, level:Int, xoffset:Int, yoffset:Int, format:Int, type:Int, pixels:#if (js && html5) ImageData #else Dynamic #end):Void {
	// public texSubImage2D (target:Int, level:Int, xoffset:Int, yoffset:Int, format:Int, type:Int, pixels:#if (js && html5) ImageElement #else Dynamic #end):Void {
	// public texSubImage2D (target:Int, level:Int, xoffset:Int, yoffset:Int, format:Int, type:Int, pixels:#if (js && html5) VideoElement #else Dynamic #end):Void {
	// public texSubImage2D (target:Int, level:Int, xoffset:Int, yoffset:Int, width:Int, height:Int, format:Int, type:Int, srcData:ArrayBufferView):Void {
	public texSubImage2D(target : number, level : number, xoffset : number, yoffset : number, width : number, height : number, format: Dynamic, ?type : number, ?srcData: Dynamic): void
		{
			this.texSubImage2D(target, level, xoffset, yoffset, width, height, format, type, srcData);
		}
	#end

	public uniformMatrix2fv(location: GLUniformLocation, transpose : boolean, v : Float32Array): void
		{
			this.uniformMatrix2fv(location, transpose, v);
		}

	public uniformMatrix3fv(location: GLUniformLocation, transpose : boolean, v : Float32Array): void
		{
			this.uniformMatrix3fv(location, transpose, v);
		}

	public uniformMatrix4fv(location: GLUniformLocation, transpose : boolean, v : Float32Array): void
		{
			this.uniformMatrix4fv(location, transpose, v);
		}

	@: from private static fromWebGL2RenderContext(gl: WebGL2RenderContext): WebGLRenderContext
	{
		return cast gl;
	}

	@: from private static fromRenderContext(context: RenderContext): WebGLRenderContext
	{
		return context.webgl;
	}

	@: from private static fromGL(gl: Class<GL>): WebGLRenderContext
	{
			return cast GL.context;
		}

	#if(!doc_gen && lime_opengl)
	@: from private static fromOpenGLContext(gl: OpenGLRenderContext): WebGLRenderContext
	{
	...
	@: from private static fromOpenGLES2Context(gl: OpenGLES2RenderContext): WebGLRenderContext
	{
		#if(sys && lime_cffi && lime_opengl)
		return cast gl;
		#else
	...
	#if(!doc_gen && (lime_opengl || lime_opengles))
	@: from private static fromOpenGLES3Context(gl: OpenGLES3RenderContext): WebGLRenderContext
	{
		#if(sys && lime_cffi && lime_opengl)
		return cast gl;
		#else
