...
class Base64
{
	private static DICTIONARY: Array<string> = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".split("");
	private static EXTENDED_DICTIONARY: Array<string> =
		{
...
public static decode(source: string): Bytes
{
	return HaxeBase64.decode(source);
}

public static encode(source: Bytes): string
{
	var result = new Array<string>();
