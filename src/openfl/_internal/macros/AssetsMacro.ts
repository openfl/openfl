namespace openfl._internal.macros;
...
class AssetsMacro
{
	...
	private static base64Encoder: BaseCode;
	#if 0
	private static __suppressWarning: Array<Class<Dynamic>> = [Expr];
	#end

	private static base64Encode(bytes: Bytes): string
	{
	...
	macro public static embedBitmap(): Array<Field>
	{
		#if html5
	...
	macro public static embedFile(): Array<Field>
	{
