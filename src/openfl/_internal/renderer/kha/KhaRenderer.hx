...
class KhaRenderer extends AbstractRenderer {
	...
	public function new (stage:Stage) {
		...
		if (Graphics.maxTextureWidth == null) {
			...
			// TODO: Graphics.maxTextureWidth = Graphics.maxTextureHeight = gl.getInteger (gl.MAX_TEXTURE_SIZE);
	...
	public override function render ():Void {
		...
		framebuffer.g4.clear(kha.Color.White);
