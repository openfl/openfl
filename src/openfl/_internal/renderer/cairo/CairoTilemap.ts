...
class CairoTilemap
{
	public static render(tilemap: Tilemap, renderer: CairoRenderer): void
	{
	...
	private static renderTileContainer(group: TileContainer, renderer: CairoRenderer, parentTransform: Matrix, defaultTileset: Tileset, smooth: boolean,
		alphaEnabled: boolean, worldAlpha: number, blendModeEnabled: boolean, defaultBlendMode: BlendMode, cacheBitmapData: BitmapData,
