...
class CairoRenderer extends CairoRendererAPI
{
	...
	private __matrix3: Matrix3;
	private __colorTransform: ColorTransform;

	private new(cairo: Cairo)
	{
		super(cairo);
	...
	publicapplyMatrix(transform: Matrix, cairo: Cairo = null): void
	{
	...
	private __setBlendModeCairo(cairo: Cairo, value: BlendMode): void
	{
		switch (value)
		{
			case ADD:
