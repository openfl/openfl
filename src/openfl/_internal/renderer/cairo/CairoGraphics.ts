...
class CairoGraphics
{
	...
	private static cairo: Cairo;
	private static fillCommands: DrawCommandBuffer = new DrawCommandBuffer();
	private static fillPattern: CairoPattern;
	private static fillPatternMatrix: Matrix;
	...
	private static strokePattern: CairoPattern;
	private static tempMatrix3: Matrix3 = new Matrix3();
	...
	private static createGradientPattern(type: GradientType, colors: Array<Dynamic>, alphas: Array<Dynamic>, ratios: Array<Dynamic>, matrix: Matrix,
		spreadMethod: SpreadMethod, interpolationMethod: numbererpolationMethod, focalPointRatio: number): CairoPattern
	{
	...
	private static createImagePattern(bitmapFill: BitmapData, matrix: Matrix, bitmapRepeat: boolean, smooth: boolean): CairoPattern
	{
	...
	private static readonly isCCW(x1: number, y1: number, x2: number, y2: number, x3: number, y3: number)
	{
	...
	private static quadraticCurveTo(cx: number, cy: number, x: number, y: number): void
	{
		var current = null;
	...
	public static render(graphics: Graphics, renderer: CairoRenderer): void
	{
		CairoGraphics.graphics = graphics;
	...
	public static renderMask(graphics: Graphics, renderer: CairoRenderer): void
	{
