...
class FlashGraphics
{
	public static bitmapFill: Dictionary<Graphics, BitmapData> = new Dictionary(true);
	private static tileRect: Rectangle = new Rectangle();
	private static tileTransform: Matrix = new Matrix();

	public static drawGraphicsData(graphics: Graphics, graphicsData: Vector<IGraphicsData>): void
	{
