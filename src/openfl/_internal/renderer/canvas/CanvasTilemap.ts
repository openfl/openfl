...
class CanvasTilemap
{
	public static readonly render(tilemap: Tilemap, renderer: CanvasRenderer): void
	{
		#if openfl_html5
	...
	private static renderTileContainer(group: TileContainer, renderer: CanvasRenderer, parentTransform: Matrix, defaultTileset: Tileset, smooth: boolean,
		alphaEnabled: boolean, worldAlpha: number, blendModeEnabled: boolean, defaultBlendMode: BlendMode, cacheBitmapData: BitmapData, source: Dynamic,
		rect: Rectangle): void
	{
