...
class CanvasRenderer extends CanvasRendererAPI
{
	...
	private __domRenderer: DOMRenderer;
	private __transform: Matrix;

	private new(context: Canvas2DRenderContext)
	{
		super(context);
	...
	publicapplySmoothing(context: Canvas2DRenderContext, value: boolean): void
	{
		context.imageSmoothingEnabled = value;
	}

	publicsetTransform(transform: Matrix, context: Canvas2DRenderContext = null): void
	{
		if (context == null)
		{
	...
	private __setBlendModeContext(context: Canvas2DRenderContext, value: BlendMode): void
	{
		switch (value)
		{
			case ADD:
