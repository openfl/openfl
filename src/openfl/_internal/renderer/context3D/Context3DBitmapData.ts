...
{
	private static readonly VERTEX_BUFFER_STRIDE: number = 14;
...
private static setVertex(bitmapData: BitmapData, index : number, x : number, y : number, u : number, v : number): void
	{
...
private static setVertices(bitmapData: BitmapData, indices: Array < Int >, x : number, y : number, u : number, v : number): void
	{
...
private static setUOffsets(bitmapData: BitmapData, indices: Array < Int >, offset : number): void
	{
		for(index in indices)
	{
...
private static setVOffsets(bitmapData: BitmapData, indices: Array < Int >, offset : number): void
	{
		for(index in indices)
	{
