...
{
	private static cacheColorTransform: ColorTransform;

	private static buildBufferTileContainer(tilemap: Tilemap, group: TileContainer, renderer: Context3DRenderer, parentTransform: Matrix,
	...
	public static renderMask(tilemap: Tilemap, renderer: Context3DRenderer): void
	{
		...
		// uMatrix = renderer.__getMatrix (tilemap.__renderTransform);
		// smoothing = (renderer.__allowSmoothing && tilemap.smoothing);

		// tileArray = tilemap.__tileArray;
		// defaultTileset = tilemap.__tileset;
