...
export default class Mouse
{
	/**
		...
		**Note:** For Flash Player 10.2 or AIR 2.6 and later versions, this
		...
		@throws ArgumentError If set to any value which is not a member of
							  ...
							  method.
	**/
	public static cursor(get, set): MouseCursor;
	...
	**/
	public static supportsCursor(default , null): boolean = #if !mobile true; #else false; #end

	/**
		Indicates whether the current configuration supports native cursors.
	**/
	public static supportsNativeCursor(default , null): boolean = #if !mobile true; #else false; #end
	...
	**/
	...
	{
		MouseBackend.setStageCursor(stage, cursor);
	}
	...
	**/
	...
	// Get & Set Methods
	protected static get cursor(): MouseCursor
	{
		return __cursor;
	}

	protected static set cursor(value: MouseCursor): void
	{
		if (value == null) value = AUTO;
		MouseBackend.setCursor(value);
		__cursor = value;
	}
}
