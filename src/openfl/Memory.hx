...
class Memory
{
	...
	{
		#if debug
		if (addr < 0 || addr + 1 > len) throw("Bad address");
		#end
	...
	{
		#if debug
		if (addr < 0 || addr + 8 > len) throw("Bad address");
		#end
	...
	{
		#if debug
		if (addr < 0 || addr + 4 > len) throw("Bad address");
		#end
	...
	{
		#if debug
		if (addr < 0 || addr + 2 > len) throw("Bad address");
		#end
