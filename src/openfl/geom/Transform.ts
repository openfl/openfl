...
namespace openfl.geom
{
	...
	**/
	export class Transform
	{
		...
		**/
		public concatenatedColorTransform(default , null): ColorTransform;
		...
		/**
			...
			the Stage.
		**/
		public concatenatedMatrix(get, never): Matrix;
		...
		**/
		...
		/**
			...
			`null`.
		**/
		public matrix3D(get, set): Matrix3D;
		...
		/**
			...
			object on the stage.
		**/
		public pixelBounds(default , null): Rectangle;
...
export default openfl.geom.Transform;
