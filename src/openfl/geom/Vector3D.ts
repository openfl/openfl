...
**/
	export class Vector3D
	{
		...
		**/
		public static X_AXIS(get, never): Vector3D;

		/**
			The y axis defined as a Vector3D object with coordinates (0,1,0).
		**/
		public static Y_AXIS(get, never): Vector3D;

		/**
			The z axis defined as a Vector3D object with coordinates (0,0,1).
		**/
		public static Z_AXIS(get, never): Vector3D;
		...
		**/
		public lengthSquared(get, never): number;
		...
		**/
		...
		private inline static get_X_AXIS(): Vector3D
		{
			return new Vector3D(1, 0, 0);
		}

		private inline static get_Y_AXIS(): Vector3D
		{
			return new Vector3D(0, 1, 0);
		}

		private inline static get_Z_AXIS(): Vector3D
		{
