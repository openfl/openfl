...
namespace openfl.geom
{
	...
	**/
	...
	{
		protected static __pool: ObjectPool<Rectangle> = new ObjectPool<Rectangle>(function () return new Rectangle(),
...
/**
	...
	![A rectangle image showing location and measurement properties.](/images/rectangle.jpg)
**/
public bottomRight(get, set): Point;
...
if (cacheBottom < y + height) this.height = y + height - this.y;
	...
	#if lime
	protected __toLimeRectangle(): LimeRectangle
{
	...
	protected get_bottom() : number
{
	...
	protected set_bottom(b : number) : number
{
	height = b - y;
	return b;
}
	...
	protected get_bottomRight(): Point
{
	...
	protected set_bottomRight(p: Point): Point
{
	width = p.x - x;
	height = p.y - y;
	return p.clone();
	...
	protected get_left() : number
{
	...
	protected set_left(l : number) : number
{
	width -= l - x;
	x = l;
	return l;
	...
	protected get_right() : number
{
	...
	protected set_right(r : number) : number
{
	width = r - x;
	return r;
}
	...
	protected get_size(): Point
{
	...
	protected set_size(p: Point): Point
{
	width = p.x;
	height = p.y;
	return p.clone();
	...
	protected get_top() : number
{
	...
	protected set_top(t : number) : number
{
	height -= t - y;
	y = t;
	return t;
	...
	protected get_topLeft(): Point
{
	...
	protected set_topLeft(p: Point): Point
{
	x = p.x;
	y = p.y;
	return p.clone();
