...
export default class ApplicationDomain
{
	...
	**/
	public static currentDomain(default , null) = new ApplicationDomain(null);
...
**/
public parentDomain(default, null): ApplicationDomain;
...
/**
	...
	@throws ReferenceError No public definition exists with the specified
						   name.
**/
public getDefinition(name: string): Class < Dynamic >
{
