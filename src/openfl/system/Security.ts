...
export default class Security
{
	...
	**/
	public static readonly LOCAL_TRUSTED: string = "localTrusted";
	...
	/**
		...
		Internet.
	**/
	public static readonly LOCAL_WITH_FILE: string = "localWithFile";
	...
	/**
		...
		sources.
	**/
	public static readonly LOCAL_WITH_NETWORK: string = "localWithNetwork";

	/**
		The file is from an Internet URL and operates under domain-based
		sandbox rules.
	**/
	public static readonly REMOTE: string = "remote";

	/**
		Undocumented property
	**/
	/** @hidden */ public static disableAVM1Loading: boolean;
