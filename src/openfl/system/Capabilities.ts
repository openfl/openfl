...
export default class Capabilities
{
	/**
		...
		microphone.
	**/
	public static avHardwareDisable(default , null) = true;
	...
	**/
	public static cpuArchitecture(get, never): string;
	...
	**/
	public static hasAudioEncoder(default , null) = false;
	...
	/**
		...
		`EV`.
	**/
	public static hasEmbeddedVideo(default , null) = false;
	...
	**/
	public static hasIME(default , null) = false;
	...
	/**
		...
		`MP3`.
	**/
	public static hasMP3(default , null) = false;
	...
	/**
		...
		`PR`.
	**/
	public static hasPrinting(default , null) = #if html5 true #else false #end;
...
/**
	...
	`SB`.
**/
public static hasScreenBroadcast(default, null) = false;
...
/**
	...
	`SP`.
**/
public static hasScreenPlayback(default, null) = false;
...
/**
	...
	`SA`.
**/
public static hasStreamingAudio(default, null) = false;
...
/**
	...
	`SV`.
**/
public static hasStreamingVideo(default, null) = false;
...
**/
public static hasTLS(default, null) = true;
...
**/
public static hasVideoEncoder(default, null) = #if html5 true #else false #end;
...
**/
public static isDebugger(default, null) = #if debug true #else false #end;

/**
	Specifies whether the Flash runtime is embedded in a PDF file that is open
	in Acrobat 9.0 or higher(`true`) or not(`false`).
**/
public static isEmbeddedInAcrobat(default, null) = false;
...
**/
public static language(get, never): string;
...
**/
public static localFileReadDisable(default, null) = #if web true #else false #end;
...
**/
public static manufacturer(get, never): string;
...
**/
public static maxLevelIDC(default, null) = 0;
...
**/
public static os(get, never): string;

/**
	Specifies the pixel aspect ratio of the screen. The server string is
	`AR`.
**/
public static pixelAspectRatio(get, never) : number;
...
**/
public static playerType(default, null) = #if web "PlugIn" #else "StandAlone" #end;
...
/**
	...
	`COL`.
**/
public static screenColor(default, null) = "color";

/**
	Specifies the dots-per-inch(dpi) resolution of the screen, in pixels. The
	server string is `DP`.
**/
public static screenDPI(get, never) : number;
...
/**
	...
	screen.
**/
public static screenResolutionX(get, never) : number;
...
**/
public static screenResolutionY(get, never) : number;
...
**/
public static serverString(default, null) = ""; // TODO

/**
	Specifies whether the system supports running 32-bit processes. The server
	string is `PR32`.
**/
public static supports32BitProcesses(default, null) = #if sys true #else false #end;

/**
	Specifies whether the system supports running 64-bit processes. The server
	string is `PR64`.
**/
public static supports64BitProcesses(default, null) = #if desktop true #else false #end; // TODO

/**
	Specifies the type of touchscreen supported, if any. Values are defined in
	the openfl.system.TouchscreenType class.
**/
public static touchscreenType(default, null) = TouchscreenType.FINGER; // TODO
...
**/
public static version(get, never): string;
...
public static hasMultiChannelAudio(type: string) : boolean
{
	...
	// Getters & Setters
	protected static readonly get_cpuArchitecture(): string
{
	...
	protected static get_language(): string
{
	...
	protected static readonly get_manufacturer(): string
{
	return CapabilitiesBackend.getManufacturer();
}

	protected static readonly get_os(): string
{
