...
class Future<T> {
	...
	public function onComplete (listener:T->Void):Future<T> { return this; }
	public function onError (listener:Dynamic->Void):Future<T> { return this; }
