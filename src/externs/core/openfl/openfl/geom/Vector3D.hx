...
extern class Vector3D {
	...
	@:dox(hide) @:noCompletion private function get_X_AXIS ():Vector3D;
	
	public static var Y_AXIS (get, never):Vector3D;
	
	@:dox(hide) @:noCompletion private function get_Y_AXIS ():Vector3D;
	
	public static var Z_AXIS (get, never):Vector3D;
	
	@:dox(hide) @:noCompletion private function get_Z_AXIS ():Vector3D;
	...
	@:dox(hide) @:noCompletion private function get_lengthSquared ():Float;
