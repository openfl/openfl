...
extern class Transform {
	...
	@:dox(hide) @:noCompletion private function get_concatenatedMatrix ():Matrix;
	@:dox(hide) @:noCompletion private function set_concatenatedMatrix (value:Matrix):Matrix;
	...
	@:dox(hide) @:noCompletion private function get_matrix3D ():Matrix3D;
	@:dox(hide) @:noCompletion private function set_matrix3D (value:Matrix3D):Matrix3D;
