...
extern class URLRequestDefaults {
	...
	private inline static function get_followRedirects ():Bool { return true; }
	private inline static function set_followRedirects (value:Bool):Bool { return value; }
	
	public static var idleTimeout(get, set):Float;
	private inline static function get_idleTimeout ():Float { return 30000; }
	private inline static function set_idleTimeout (value:Float):Float { return value; }
	
	public static var manageCookies(get, set):Bool;
	private inline static function get_manageCookies ():Bool { return true; }
	private inline static function set_manageCookies (value:Bool):Bool { return value; }
	#end
	...
	private inline static function get_userAgent ():String { return null; }
	private inline static function set_userAgent (value:String):String { return value; }
	#end
