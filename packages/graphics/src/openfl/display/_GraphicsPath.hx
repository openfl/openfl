...
#end
@:noCompletion
class _GraphicsPath implements _IGraphicsData
{
	...
	public function __drawCircle(x:Float, y:Float, radius:Float):Void
	{
		__drawRoundRect(x - radius, y - radius, radius * 2, radius * 2, radius * 2, radius * 2);
	}

	public function __drawEllipse(x:Float, y:Float, width:Float, height:Float):Void
	{
		__drawRoundRect(x, y, width, height, width, height);
	}

	public function __drawRect(x:Float, y:Float, width:Float, height:Float):Void
	{
		moveTo(x, y);
		lineTo(x + width, y);
	...
	public function __drawRoundRect(x:Float, y:Float, width:Float, height:Float, ellipseWidth:Float, ellipseHeight:Float):Void
	{
		ellipseWidth *= 0.5;
		ellipseHeight *= 0.5;
