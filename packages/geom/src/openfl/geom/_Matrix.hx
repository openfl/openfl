...
class _Matrix
{
	public static var __identity:Matrix = new Matrix();
	public static var __pool:ObjectPool<Matrix> = new ObjectPool<Matrix>(function() return new Matrix(), function(m) m.identity());
	#if lime
	public static var __matrix3:Matrix3 = new Matrix3();
	#end
	...
	public function setRotation(theta:Float, scale:Float = 1):Void
	{
	...
	public inline function toMozString():String
	{
	...
	#if openfl_gl
	public function toArray(transpose:Bool = false):Float32Array
	{
		if (__array == null)
		{
	...
	public inline function __cleanValues():Void
	{
	...
	#if lime
	public function __toMatrix3():Matrix3
	{
