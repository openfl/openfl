...
{
	#if lime
	public static var __limeRectangle:LimeRectangle;
	#end
	public static var __pool:ObjectPool<Rectangle> = new ObjectPool<Rectangle>(function() return new Rectangle(), function(r) r.setTo(0, 0, 0, 0));
	...
	#if lime
	public function __toLimeRectangle():LimeRectangle
	{
