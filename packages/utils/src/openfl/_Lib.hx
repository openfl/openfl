...
class _Lib
{
	...
	public static inline function get_application():Application
	{
	...
	public static var __sentWarnings:Map<String, Bool> = new Map();
	public static var __timers:Map<UInt, Timer> = new Map();
	...
	// public static function set_current (current:MovieClip):MovieClip {
	// 	return cast flash.Lib.current = cast current;
	// }
	#if lime
	public static function get_limeApplication():Application
	{
