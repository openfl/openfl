...
class _Assets
{
	...
	public static var dispatcher:EventDispatcher #if !macro = new EventDispatcher() #end;
	...
	@:analyzer(ignore) public static function isValidBitmapData(bitmapData:BitmapData):Bool
	{
		#if (lime && tools && !display)
		#if flash
		try
		...
		#else
		return (bitmapData != null && #if !lime_hybrid bitmapData.limeImage != null #else bitmapData._.__handle != null #end);
		#end
		#else
		return true;
		#end
	...
	public static function isValidSound(sound:Sound):Bool
	{
		#if ((tools && !display) && (cpp || neko || nodejs))
		return true;
		// return (sound._.__handle != null && sound._.__handle != 0);
		#else
		return true;
		#end
	}
