...
@:final class IndexBuffer3D
{
	...
	**/
	...
	{
		_.uploadFromByteArray(data, byteArrayOffset, startOffset, count);
	}
	...
	**/
	...
	{
		_.uploadFromTypedArray(data, byteLength);
	}
	...
	**/
	...
	{
		_.uploadFromVector(data, startOffset, count);
	}
}
#else
