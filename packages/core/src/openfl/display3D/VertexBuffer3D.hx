...
{
	@:noCompletion private var _:_VertexBuffer3D;
	...
	**/
	...
	{
		_.uploadFromByteArray(data, byteArrayOffset, startVertex, numVertices);
	}
	...
	**/
	...
	{
		_.uploadFromVector(data, startVertex, numVertices);
	}
}
#else
