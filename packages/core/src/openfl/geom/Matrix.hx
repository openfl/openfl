...
class Matrix
{
	...
	**/
	...
	@:allow(openfl) @:noCompletion private var _:_Matrix;
	...
	**/
	...
	{
		_.createBox(scaleX, scaleY, rotation, tx, ty);
	}
	...
	**/
	...
	{
		_.createGradientBox(width, height, rotation, tx, ty);
	}
	...
	**/
	...
	{
		return _.deltaTransformPoint(point);
	}
