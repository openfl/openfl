...
class Matrix3D
{
	...
	**/
	...
	@:allow(openfl) @:noCompletion private var _:_Matrix3D;
	...
	**/
	...
	{
		_.appendRotation(degrees, axis, pivotPoint);
	}
	...
	**/
	...
	{
		_.appendScale(xScale, yScale, zScale);
	}
	...
	**/
	...
	{
		_.copyColumnFrom(column, vector3D);
	}
	...
	**/
	...
	{
		_.copyColumnTo(column, vector3D);
	}
	...
	**/
	...
	{
		_.copyRawDataFrom(vector, index, transpose);
	}
	...
	**/
	...
	{
		_.copyRawDataTo(vector, index, transpose);
	}
	...
	**/
	...
	{
		return _.decompose(orientationStyle);
	}
	...
	**/
	...
	{
		return _.deltaTransformVector(v);
	}
	...
	**/
	...
	{
		return _Matrix3D.interpolate(thisMat, toMat, percent);
	}
	...
	**/
	...
	{
		_.prependRotation(degrees, axis, pivotPoint);
	}
	...
	**/
	...
	{
		_.prependScale(xScale, yScale, zScale);
	}
	...
	**/
	...
	{
		return _.recompose(components, orientationStyle);
	}
