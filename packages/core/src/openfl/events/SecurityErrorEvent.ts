...
/**
	...
	error.
**/
export default class SecurityErrorEvent extends ErrorEvent
{
	/**
	...
	**/
	public static readonly SECURITY_ERROR: EventType<SecurityErrorEvent> = "securityError";

	protected static __pool: ObjectPool<SecurityErrorEvent> = new ObjectPool<SecurityErrorEvent>(() =>
		new SecurityErrorEvent(null), (event) => event.__init());
	...
	**/
	...
	public clone(): SecurityErrorEvent
	{
