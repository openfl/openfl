...
{
	@:allow(openfl) private var _:_Graphics;

	@:allow(openfl) @:noCompletion private function new(owner:DisplayObject)
	{
		if (_ == null)
		{
	...
	**/
	...
	{
		_.beginBitmapFill(bitmap, matrix, repeat, smooth);
	}
	...
	**/
	...
	{
		_.beginGradientFill(type, colors, alphas, ratios, matrix, spreadMethod, interpolationMethod, focalPointRatio);
	}
	...
	**/
	...
	{
		_.beginShaderFill(shader, matrix);
	}
	...
	**/
	...
	{
		_.cubicCurveTo(controlX1, controlY1, controlX2, controlY2, anchorX, anchorY);
	}
	...
	**/
	...
	{
		_.curveTo(controlX, controlY, anchorX, anchorY);
	}
	...
	**/
	...
	{
		_.drawEllipse(x, y, width, height);
	}
	...
	**/
	...
	{
		_.drawGraphicsData(graphicsData);
	}
	...
	**/
	...
	{
		_.drawPath(commands, data, winding);
	}
	...
	**/
	...
	{
		_.drawQuads(rects, indices, transforms);
	}
	...
	**/
	...
	{
		_.drawRoundRect(x, y, width, height, ellipseWidth, ellipseHeight);
	}
	...
	**/
	...
	{
		_.drawRoundRectComplex(x, y, width, height, topLeftRadius, topRightRadius, bottomLeftRadius, bottomRightRadius);
	}
	...
	**/
	...
	{
		_.drawTriangles(vertices, indices, uvtData, culling);
	}
	...
	**/
	...
	{
		_.lineBitmapStyle(bitmap, matrix, repeat, smooth);
	}
	...
	**/
	public function lineGradientStyle(type:GradientType, colors:Array<Int>, alphas:Array<Float>, ratios:Array<Int>, matrix:Matrix = null,
			spreadMethod:SpreadMethod = SpreadMethod.PAD, interpolationMethod:InterpolationMethod = InterpolationMethod.RGB, focalPointRatio:Float = 0):Void
	{
		_.lineGradientStyle(type, colors, alphas, ratios, matrix, spreadMethod, interpolationMethod, focalPointRatio);
	}
	...
	**/
	...
	{
		_.lineStyle(thickness, color, alpha, pixelHinting, scaleMode, caps, joints, miterLimit);
	}
	...
	**/
	...
	{
		return _.readGraphicsData(recurse);
	}
}
#else
