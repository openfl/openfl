...
**/
export default class URLRequestDefaults
{
	...
	**/
	public static followRedirects: boolean = true;
	...
	**/
	public static idleTimeout: number = 0;
	...
	/**
		...
		**Note:** This setting does not apply to URLRequest objects used in file upload
		...
		The default value is `true`.
	**/
	public static manageCookies: boolean = false;

	// public static useCache:Bool;
	...
	**/
	...
	// public static setLoginCredentialsForHost (hostname:String, user:String, password:String):Dynamic {
