...
#if !flash
import openfl._internal.BoolVector;
import openfl._internal.FloatVector;
import openfl._internal.IntVector;
import openfl._internal.IVector;
import openfl._internal.ObjectVector;
#if !cs
import openfl._internal.FunctionVector;
#end
#end
