...
declare namespace openfl.display {
	...
	export class Stage extends DisplayObjectContainer /*implements IModule*/ {
		 ...
		 */
		public readonly allowsFullScreen:boolean;
		...
		// #if flash
		// @:noCompletion @:dox(hide) @:require(flash10) public colorCorrectionSupport (default, null):flash.display.ColorCorrectionSupport;
		// #end
		...
		// #if flash
		// @:noCompletion @:dox(hide) @:require(flash11) public softKeyboardRect (default, null):Rectangle;
		// #end
		
		public readonly stage3Ds:Vector<Stage3D>;
		...
		// #if flash
		// @:noCompletion @:dox(hide) @:require(flash10_2) public stageVideos (default, null):Vector<flash.media.StageVideo>;
		// #end
		...
		public constructor (width?:number, height?:number, color?:number | null, documentClass?:any, windowConfig?:object);
		// #end
		...
		// #if flash
		// @:noCompletion @:dox(hide) public function isFocusInaccessible ():boolean;
		// #end
