package openfl.utils {
	...
	public class ByteArray implements IDataOutput, IDataInput /*implements ArrayAccess<Int>*/ {
		...
		//public static function fromBytes(bytes:Bytes):ByteArray { return null; }
		//public static function fromArrayBuffer(buffer:ArrayBuffer):ByteArray { return null; }
		...
		//public static function loadFromBytes(bytes:Bytes):Future<ByteArray> { return null; }
		//public static function loadFromFile(path:String):Future<ByteArray> { return null; }
