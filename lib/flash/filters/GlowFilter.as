package flash.filters {
	...
	final public class GlowFilter extends BitmapFilter {
		 ...
		 *                 document.
		 */
		public function GlowFilter (color:int = 0xFF0000, alpha:Number = 1, blurX:Number = 6, blurY:Number = 6, strength:Number = 2, quality:int = 1, inner:Boolean = false, knockout:Boolean = false) {}
