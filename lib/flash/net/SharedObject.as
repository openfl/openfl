package flash.net {
	...
	public class SharedObject extends EventDispatcher {
		...
		protected function get_size ():uint { return 0; }
		 ...
		 *               disallowed.
		 */
		public function flush (minDiskSpace:int = 0):String { return null; }
		 ...
		 */
		public static function getLocal (name:String, localPath:String = null, secure:Boolean = false):SharedObject { return null; }
