package flash.display {
	...
	* parameters of the `flash.display.BitmapData.copyChannel()`
	* method
	*  * The `channelOptions` parameter of the
	* `flash.display.BitmapData.noise()` method
	*  * The `flash.filters.DisplacementMapFilter.componentX` and
	* `flash.filters.DisplacementMapFilter.componentY` properties
	* 
	*/
