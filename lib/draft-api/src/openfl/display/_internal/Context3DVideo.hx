...
class Context3DVideo
{
	...
	public static function render(video:Video, renderer:OpenGLRenderer):Void
	{
		...
		{
			#if (js && html5)
			__textureSizeValue[0] = (video.__stream != null && video.__stream.__video != null) ? video.__stream.__video.videoWidth : 0;
			__textureSizeValue[1] = (video.__stream != null && video.__stream.__video != null) ? video.__stream.__video.videoHeight : 0;
			#elseif (cpp && windows)
			__textureSizeValue[0] = video.__nativeVideoWidth;
			__textureSizeValue[1] = video.__nativeVideoHeight;
			#end
