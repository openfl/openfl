...
@:final extern class Graphics {
	...
	@:require(flash10) function drawGraphicsData(graphicsData : openfl.Vector<IGraphicsData>) : Void;
	@:require(flash10) function drawPath(commands : openfl.Vector<Int>, data : openfl.Vector<Float>, ?winding : GraphicsPathWinding) : Void;
	...
	@:require(flash11_6) function readGraphicsData(recurse : Bool = true) : openfl.Vector<IGraphicsData>;
}
