...
class SWFColorTransform
{
	...
	public var rMult:Int = 0x100;
	public var gMult:Int = 0x100;
	public var bMult:Int = 0x100;
	public var rAdd:Int = 0;
	public var gAdd:Int = 0;
	public var bAdd:Int = 0;

	public var aMult:Int = 0x100;
	...
	private function get_colorTransform():ColorTransform {
		return new ColorTransform(rMult / 0x100, gMult / 0x100, bMult / 0x100, aMult / 0x100, rAdd, gAdd, bAdd, aAdd);
	}
