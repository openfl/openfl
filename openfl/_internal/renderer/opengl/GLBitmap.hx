...
class GLBitmap {
	...
	public static inline function render (bitmap:Bitmap, renderSession:RenderSession):Void {
		...
		renderSession.spriteBatch.renderBitmapData(bitmap.bitmapData, bitmap.smoothing, bitmap.__renderMatrix, bitmap.__worldColorTransform, bitmap.__worldAlpha, bitmap.__blendMode, bitmap.__shader, bitmap.pixelSnapping);
	}
