...
class WeakRef<T> {
	...
	private static var lime_weak_ref_create:Dynamic = Lib.load ("lime-legacy", "lime_weak_ref_create", 2);
	private static var lime_weak_ref_get:Dynamic = Lib.load ("lime-legacy", "lime_weak_ref_get", 1);
