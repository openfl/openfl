...
class TextField extends InteractiveObject {
	...
	private static var lime_text_field_create = Lib.load ("lime-legacy", "lime_text_field_create", 0);
	private static var lime_text_field_get_text = Lib.load ("lime-legacy", "lime_text_field_get_text", 1);
	private static var lime_text_field_set_text = Lib.load ("lime-legacy", "lime_text_field_set_text", 2);
	private static var lime_text_field_get_html_text = Lib.load ("lime-legacy", "lime_text_field_get_html_text", 1);
	private static var lime_text_field_set_html_text = Lib.load ("lime-legacy", "lime_text_field_set_html_text", 2);
	private static var lime_text_field_get_text_color = Lib.load ("lime-legacy", "lime_text_field_get_text_color", 1);
	private static var lime_text_field_set_text_color = Lib.load ("lime-legacy", "lime_text_field_set_text_color", 2);
	private static var lime_text_field_get_selectable = Lib.load ("lime-legacy", "lime_text_field_get_selectable", 1);
	private static var lime_text_field_set_selectable = Lib.load ("lime-legacy", "lime_text_field_set_selectable", 2);
	private static var lime_text_field_get_display_as_password = Lib.load ("lime-legacy", "lime_text_field_get_display_as_password", 1);
	private static var lime_text_field_set_display_as_password = Lib.load ("lime-legacy", "lime_text_field_set_display_as_password", 2);
	private static var lime_text_field_get_embed_fonts = Lib.load ("lime-legacy", "lime_text_field_get_embed_fonts", 1);
	private static var lime_text_field_set_embed_fonts = Lib.load ("lime-legacy", "lime_text_field_set_embed_fonts", 2);
	private static var lime_text_field_get_def_text_format = Lib.load ("lime-legacy", "lime_text_field_get_def_text_format", 2);
	private static var lime_text_field_set_def_text_format = Lib.load ("lime-legacy", "lime_text_field_set_def_text_format", 2);
	private static var lime_text_field_get_auto_size = Lib.load ("lime-legacy", "lime_text_field_get_auto_size", 1);
	private static var lime_text_field_set_auto_size = Lib.load ("lime-legacy", "lime_text_field_set_auto_size", 2);
	private static var lime_text_field_get_type = Lib.load ("lime-legacy", "lime_text_field_get_type", 1);
	private static var lime_text_field_set_type = Lib.load ("lime-legacy", "lime_text_field_set_type", 2);
	private static var lime_text_field_get_multiline = Lib.load ("lime-legacy", "lime_text_field_get_multiline", 1);
	private static var lime_text_field_set_multiline = Lib.load ("lime-legacy", "lime_text_field_set_multiline", 2);
	private static var lime_text_field_get_word_wrap = Lib.load ("lime-legacy", "lime_text_field_get_word_wrap", 1);
	private static var lime_text_field_set_word_wrap = Lib.load ("lime-legacy", "lime_text_field_set_word_wrap", 2);
	private static var lime_text_field_get_border = Lib.load ("lime-legacy", "lime_text_field_get_border", 1);
	private static var lime_text_field_set_border = Lib.load ("lime-legacy", "lime_text_field_set_border", 2);
	private static var lime_text_field_get_border_color = Lib.load ("lime-legacy", "lime_text_field_get_border_color", 1);
	private static var lime_text_field_set_border_color = Lib.load ("lime-legacy", "lime_text_field_set_border_color", 2);
	private static var lime_text_field_get_background = Lib.load ("lime-legacy", "lime_text_field_get_background", 1);
	private static var lime_text_field_set_background = Lib.load ("lime-legacy", "lime_text_field_set_background", 2);
	private static var lime_text_field_get_background_color = Lib.load ("lime-legacy", "lime_text_field_get_background_color", 1);
	private static var lime_text_field_set_background_color = Lib.load ("lime-legacy", "lime_text_field_set_background_color", 2);
	private static var lime_text_field_get_text_width = Lib.load ("lime-legacy", "lime_text_field_get_text_width", 1);
	private static var lime_text_field_get_text_height = Lib.load ("lime-legacy", "lime_text_field_get_text_height", 1);
	private static var lime_text_field_get_text_format = Lib.load ("lime-legacy", "lime_text_field_get_text_format", 4);
	private static var lime_text_field_set_text_format = Lib.load ("lime-legacy", "lime_text_field_set_text_format", 4);
	private static var lime_text_field_get_max_scroll_v = Lib.load ("lime-legacy", "lime_text_field_get_max_scroll_v", 1);
	private static var lime_text_field_get_max_scroll_h = Lib.load ("lime-legacy", "lime_text_field_get_max_scroll_h", 1);
	private static var lime_text_field_get_bottom_scroll_v = Lib.load ("lime-legacy", "lime_text_field_get_bottom_scroll_v", 1);
	private static var lime_text_field_get_scroll_h = Lib.load ("lime-legacy", "lime_text_field_get_scroll_h", 1);
	private static var lime_text_field_set_scroll_h = Lib.load ("lime-legacy", "lime_text_field_set_scroll_h", 2);
	private static var lime_text_field_get_scroll_v = Lib.load ("lime-legacy", "lime_text_field_get_scroll_v", 1);
	private static var lime_text_field_set_scroll_v = Lib.load ("lime-legacy", "lime_text_field_set_scroll_v", 2);
	private static var lime_text_field_get_num_lines = Lib.load ("lime-legacy", "lime_text_field_get_num_lines", 1);
	private static var lime_text_field_get_max_chars = Lib.load ("lime-legacy", "lime_text_field_get_max_chars", 1);
	private static var lime_text_field_set_max_chars = Lib.load ("lime-legacy", "lime_text_field_set_max_chars", 2);
	private static var lime_text_field_get_line_text = Lib.load ("lime-legacy", "lime_text_field_get_line_text", 2);
	private static var lime_text_field_get_line_metrics = Lib.load ("lime-legacy", "lime_text_field_get_line_metrics", 3);
	private static var lime_text_field_get_line_offset = Lib.load ("lime-legacy", "lime_text_field_get_line_offset", 2);
