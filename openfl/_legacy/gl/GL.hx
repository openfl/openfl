...
class GL {
	...
	private static var lime_gl_active_texture = load ("lime_legacy_gl_active_texture", 1);
	private static var lime_gl_attach_shader = load ("lime_legacy_gl_attach_shader", 2);
	private static var lime_gl_bind_attrib_location = load ("lime_legacy_gl_bind_attrib_location", 3);
	private static var lime_gl_bind_bitmap_data_texture = load ("lime_legacy_gl_bind_bitmap_data_texture", 1);
	private static var lime_gl_bind_buffer = load ("lime_legacy_gl_bind_buffer", 2);
	private static var lime_gl_bind_framebuffer = load ("lime_legacy_gl_bind_framebuffer", 2);
	private static var lime_gl_bind_renderbuffer = load ("lime_legacy_gl_bind_renderbuffer", 2);
	private static var lime_gl_bind_texture = load ("lime_legacy_gl_bind_texture", 2);
	private static var lime_gl_blend_color = load ("lime_legacy_gl_blend_color", 4);
	private static var lime_gl_blend_equation = load ("lime_legacy_gl_blend_equation", 1);
	private static var lime_gl_blend_equation_separate = load ("lime_legacy_gl_blend_equation_separate", 2);
	private static var lime_gl_blend_func = load ("lime_legacy_gl_blend_func", 2);
	private static var lime_gl_blend_func_separate = load ("lime_legacy_gl_blend_func_separate", 4);
	private static var lime_gl_buffer_data = load ("lime_legacy_gl_buffer_data", 5);
	private static var lime_gl_buffer_sub_data = load ("lime_legacy_gl_buffer_sub_data", 5);
	private static var lime_gl_check_framebuffer_status = load ("lime_legacy_gl_check_framebuffer_status", 1);
	private static var lime_gl_clear = load ("lime_legacy_gl_clear", 1);
	private static var lime_gl_clear_color = load ("lime_legacy_gl_clear_color", 4);
	private static var lime_gl_clear_depth = load ("lime_legacy_gl_clear_depth", 1);
	private static var lime_gl_clear_stencil = load ("lime_legacy_gl_clear_stencil", 1);
	private static var lime_gl_color_mask = load ("lime_legacy_gl_color_mask", 4);
	private static var lime_gl_compile_shader = load ("lime_legacy_gl_compile_shader", 1);
	private static var lime_gl_compressed_tex_image_2d = load ("lime_legacy_gl_compressed_tex_image_2d", -1);
	private static var lime_gl_compressed_tex_sub_image_2d = load ("lime_legacy_gl_compressed_tex_sub_image_2d", -1);
	private static var lime_gl_copy_tex_image_2d = load ("lime_legacy_gl_copy_tex_image_2d", -1);
	private static var lime_gl_copy_tex_sub_image_2d = load ("lime_legacy_gl_copy_tex_sub_image_2d", -1);
	private static var lime_gl_create_buffer = load ("lime_legacy_gl_create_buffer", 0);
	private static var lime_gl_create_framebuffer = load ("lime_legacy_gl_create_framebuffer", 0);
	private static var lime_gl_create_program = load ("lime_legacy_gl_create_program", 0);
	private static var lime_gl_create_render_buffer = load ("lime_legacy_gl_create_render_buffer", 0);
	private static var lime_gl_create_shader = load ("lime_legacy_gl_create_shader", 1);
	private static var lime_gl_create_texture = load ("lime_legacy_gl_create_texture", 0);
	private static var lime_gl_cull_face = load ("lime_legacy_gl_cull_face", 1);
	private static var lime_gl_delete_buffer = load ("lime_legacy_gl_delete_buffer", 1);
	private static var lime_gl_delete_framebuffer = load ("lime_legacy_gl_delete_framebuffer", 1);
	private static var lime_gl_delete_program = load ("lime_legacy_gl_delete_program", 1);
	private static var lime_gl_delete_render_buffer = load ("lime_legacy_gl_delete_render_buffer", 1);
	private static var lime_gl_delete_shader = load ("lime_legacy_gl_delete_shader", 1);
	private static var lime_gl_delete_texture = load ("lime_legacy_gl_delete_texture", 1);
	private static var lime_gl_depth_func = load ("lime_legacy_gl_depth_func", 1);
	private static var lime_gl_depth_mask = load ("lime_legacy_gl_depth_mask", 1);
	private static var lime_gl_depth_range = load ("lime_legacy_gl_depth_range", 2);
	private static var lime_gl_detach_shader = load ("lime_legacy_gl_detach_shader", 2);
	private static var lime_gl_disable = load ("lime_legacy_gl_disable", 1);
	private static var lime_gl_disable_vertex_attrib_array = load ("lime_legacy_gl_disable_vertex_attrib_array", 1);
	private static var lime_gl_draw_arrays = load ("lime_legacy_gl_draw_arrays", 3);
	private static var lime_gl_draw_elements = load ("lime_legacy_gl_draw_elements", 4);
	private static var lime_gl_enable = load ("lime_legacy_gl_enable", 1);
	private static var lime_gl_enable_vertex_attrib_array = load ("lime_legacy_gl_enable_vertex_attrib_array", 1);
	private static var lime_gl_finish = load ("lime_legacy_gl_finish", 0);
	private static var lime_gl_flush = load ("lime_legacy_gl_flush", 0);
	private static var lime_gl_framebuffer_renderbuffer = load ("lime_legacy_gl_framebuffer_renderbuffer", 4);
	private static var lime_gl_framebuffer_texture2D = load ("lime_legacy_gl_framebuffer_texture2D", 5);
	private static var lime_gl_front_face = load ("lime_legacy_gl_front_face", 1);
	private static var lime_gl_generate_mipmap = load ("lime_legacy_gl_generate_mipmap", 1);
	private static var lime_gl_get_active_attrib = load ("lime_legacy_gl_get_active_attrib", 2);
	private static var lime_gl_get_active_uniform = load ("lime_legacy_gl_get_active_uniform", 2);
	private static var lime_gl_get_attrib_location = load ("lime_legacy_gl_get_attrib_location", 2);
	private static var lime_gl_get_buffer_paramerter = load ("lime_legacy_gl_get_buffer_paramerter", 2);
	private static var lime_gl_get_context_attributes = load ("lime_legacy_gl_get_context_attributes", 0);
	private static var lime_gl_get_error = load ("lime_legacy_gl_get_error", 0);
	private static var lime_gl_get_framebuffer_attachment_parameter = load ("lime_legacy_gl_get_framebuffer_attachment_parameter", 3);
	private static var lime_gl_get_parameter = load ("lime_legacy_gl_get_parameter", 1);
	private static var lime_gl_get_program_info_log = load ("lime_legacy_gl_get_program_info_log", 1);
	private static var lime_gl_get_program_parameter = load ("lime_legacy_gl_get_program_parameter", 2);
	private static var lime_gl_get_render_buffer_parameter = load ("lime_legacy_gl_get_render_buffer_parameter", 2);
	private static var lime_gl_get_shader_info_log = load ("lime_legacy_gl_get_shader_info_log", 1);
	private static var lime_gl_get_shader_parameter = load ("lime_legacy_gl_get_shader_parameter", 2);
	private static var lime_gl_get_shader_precision_format = load ("lime_legacy_gl_get_shader_precision_format", 2);
	private static var lime_gl_get_shader_source = load ("lime_legacy_gl_get_shader_source", 1);
	private static var lime_gl_get_supported_extensions = load ("lime_legacy_gl_get_supported_extensions", 1);
	private static var lime_gl_get_tex_parameter = load ("lime_legacy_gl_get_tex_parameter", 2);
	private static var lime_gl_get_uniform = load ("lime_legacy_gl_get_uniform", 2);
	private static var lime_gl_get_uniform_location = load ("lime_legacy_gl_get_uniform_location", 2);
	private static var lime_gl_get_vertex_attrib = load ("lime_legacy_gl_get_vertex_attrib", 2);
	private static var lime_gl_get_vertex_attrib_offset = load ("lime_legacy_gl_get_vertex_attrib_offset", 2);
	private static var lime_gl_hint = load ("lime_legacy_gl_hint", 2);
	private static var lime_gl_is_buffer = load ("lime_legacy_gl_is_buffer", 1);
	private static var lime_gl_is_enabled = load ("lime_legacy_gl_is_enabled", 1);
	private static var lime_gl_is_framebuffer = load ("lime_legacy_gl_is_framebuffer", 1);
	private static var lime_gl_is_program = load ("lime_legacy_gl_is_program", 1);
	private static var lime_gl_is_renderbuffer = load ("lime_legacy_gl_is_renderbuffer", 1);
	private static var lime_gl_is_shader = load ("lime_legacy_gl_is_shader", 1);
	private static var lime_gl_is_texture = load ("lime_legacy_gl_is_texture", 1);
	private static var lime_gl_line_width = load ("lime_legacy_gl_line_width", 1);
	...
	private static var lime_gl_read_buffer = load ("lime_gl_read_buffer", 1);
	...
	private static var lime_gl_scissor = load ("lime_legacy_gl_scissor", 4);
	private static var lime_gl_shader_source = load ("lime_legacy_gl_shader_source", 2);
	private static var lime_gl_stencil_func = load ("lime_legacy_gl_stencil_func", 3);
	private static var lime_gl_stencil_func_separate = load ("lime_legacy_gl_stencil_func_separate", 4);
	private static var lime_gl_stencil_mask = load ("lime_legacy_gl_stencil_mask", 1);
	private static var lime_gl_stencil_mask_separate = load ("lime_legacy_gl_stencil_mask_separate", 2);
	private static var lime_gl_stencil_op = load ("lime_legacy_gl_stencil_op", 3);
	private static var lime_gl_stencil_op_separate = load ("lime_legacy_gl_stencil_op_separate", 4);
	private static var lime_gl_tex_image_2d = load ("lime_legacy_gl_tex_image_2d", -1);
	private static var lime_gl_tex_parameterf = load ("lime_legacy_gl_tex_parameterf", 3);
	private static var lime_gl_tex_parameteri = load ("lime_legacy_gl_tex_parameteri", 3);
	private static var lime_gl_tex_sub_image_2d = load ("lime_legacy_gl_tex_sub_image_2d", -1);
	private static var lime_gl_uniform1f = load ("lime_legacy_gl_uniform1f", 2);
	private static var lime_gl_uniform1fv = load ("lime_legacy_gl_uniform1fv", 2);
	private static var lime_gl_uniform1i = load ("lime_legacy_gl_uniform1i", 2);
	private static var lime_gl_uniform1iv = load ("lime_legacy_gl_uniform1iv", 2);
	private static var lime_gl_uniform2f = load ("lime_legacy_gl_uniform2f", 3);
	private static var lime_gl_uniform2fv = load ("lime_legacy_gl_uniform2fv", 2);
	private static var lime_gl_uniform2i = load ("lime_legacy_gl_uniform2i", 3);
	private static var lime_gl_uniform2iv = load ("lime_legacy_gl_uniform2iv", 2);
	private static var lime_gl_uniform3f = load ("lime_legacy_gl_uniform3f", 4);
	private static var lime_gl_uniform3fv = load ("lime_legacy_gl_uniform3fv", 2);
	private static var lime_gl_uniform3i = load ("lime_legacy_gl_uniform3i", 4);
	private static var lime_gl_uniform3iv = load ("lime_legacy_gl_uniform3iv", 2);
	private static var lime_gl_uniform4f = load ("lime_legacy_gl_uniform4f", 5);
	private static var lime_gl_uniform4fv = load ("lime_legacy_gl_uniform4fv", 2);
	private static var lime_gl_uniform4i = load ("lime_legacy_gl_uniform4i", 5);
	private static var lime_gl_uniform4iv = load ("lime_legacy_gl_uniform4iv", 2);
	private static var lime_gl_uniform_matrix = load ("lime_legacy_gl_uniform_matrix", 4);
	private static var lime_gl_use_program = load ("lime_legacy_gl_use_program", 1);
	private static var lime_gl_validate_program = load ("lime_legacy_gl_validate_program", 1);
	private static var lime_gl_version = load ("lime_legacy_gl_version", 0);
	private static var lime_gl_vertex_attrib1f = load ("lime_legacy_gl_vertex_attrib1f", 2);
	private static var lime_gl_vertex_attrib1fv = load ("lime_legacy_gl_vertex_attrib1fv", 2);
	private static var lime_gl_vertex_attrib2f = load ("lime_legacy_gl_vertex_attrib2f", 3);
	private static var lime_gl_vertex_attrib2fv = load ("lime_legacy_gl_vertex_attrib2fv", 2);
	private static var lime_gl_vertex_attrib3f = load ("lime_legacy_gl_vertex_attrib3f", 4);
	private static var lime_gl_vertex_attrib3fv = load ("lime_legacy_gl_vertex_attrib3fv", 2);
	private static var lime_gl_vertex_attrib4f = load ("lime_legacy_gl_vertex_attrib4f", 5);
	private static var lime_gl_vertex_attrib4fv = load ("lime_legacy_gl_vertex_attrib4fv", 2);
	private static var lime_gl_vertex_attrib_pointer = load ("lime_legacy_gl_vertex_attrib_pointer", -1);
	private static var lime_gl_viewport = load ("lime_legacy_gl_viewport", 4);
