...
class DirectRenderer extends DisplayObject {
	...
	private static var lime_direct_renderer_create = Lib.load ("lime-legacy", "lime_direct_renderer_create", 0);
	private static var lime_direct_renderer_set = Lib.load ("lime-legacy", "lime_direct_renderer_set", 2);
