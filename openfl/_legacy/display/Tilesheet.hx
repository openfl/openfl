...
class Tilesheet {
	...
	private static var lime_tilesheet_create = Lib.load ("lime-legacy", "lime_tilesheet_create", 1);
	private static var lime_tilesheet_add_rect = Lib.load ("lime-legacy", "lime_tilesheet_add_rect", 3);
