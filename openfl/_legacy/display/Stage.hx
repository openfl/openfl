...
import openfl.events.InputEvent;
...
class Stage extends DisplayObjectContainer {
	...
	@:noCompletion private function __onInput (event:Dynamic):Void
	{
		var txt = event.text;
		var inputevent = new InputEvent(InputEvent.TEXT_INPUT, event.text);

		__dispatchEvent(inputevent);
	}
