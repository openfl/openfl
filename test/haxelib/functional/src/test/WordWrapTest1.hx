...
class WordWrapTest1 extends FunctionalTest {
	...
	public override function start ():Void {
		...
		// Mixed
		var word4 = (String.fromCharCode (0xC2) + String.fromCharCode (0x10301) + "a" + String.fromCharCode (0x9F0) + String.fromCharCode (0xD2) + "b" + String.fromCharCode (0x10303) + String.fromCharCode (0x960));
