...
class VectorTest {
	...
	@Test public function fixed () {
		...
		var vector = new Vector<Float> (0, true);
		...
		vector = new Vector<Float> (10, true);
		Assert.areEqual (10, vector.length);
		var vector2 = vector.slice (0, 2);
	...
	@Test public function new_ () {
		...
		var vector = new Vector<Float> (10, true);
	...
	@Test public function slice () {
		...
		var vector = new Vector<Float> (10);
	...
	@Test public function indexOf () {
		...
		var vector = new Vector<Float> (20);
